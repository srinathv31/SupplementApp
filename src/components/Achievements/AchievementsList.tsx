...
export default function AchievementsList({ setCompletedAchievements }: {
    ...
    const AchievementsList = [
        ...
        { name: "Night Owl 🦉", description: "Login between 1AM and 4AM", color: "skyblue" },
        { name: "Early Bird ☀️", description: "Login between 4AM and 7AM", color: "white" },
        { name: "5 Minutes Early is On Time 🕰️", description: "Schedule a time for a supplement", color: "white" },
