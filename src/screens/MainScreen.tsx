...
export default function MainScreen({ page, setPage }: {
    ...
    const [userData, setUserData] = useState<User>({ name: "Happy", age: 25, picture: "trippy_astronaut.png", data: { supplementMap: {}, selectedDates: {} }, premiumStatus: true, isLoggedIn: true });
