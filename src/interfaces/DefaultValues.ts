...
export const userDefaultValue: User = { name: "", lastName: "", age: "", picture: penguinPic, data: { supplementMap: {}, selectedDates: {}, waterGoal: 2000, selectedUnits: "ml" }, premiumStatus: true, achievements: ListOfAchievements };
